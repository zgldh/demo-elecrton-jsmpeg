...
var SOURCE_RTSP = 'rtsp://localhost:8554/pony';

var STREAM_SECRET = 'rtsp-video', //process.argv[2],
    STREAM_PORT = 8081, //process.argv[3] || 8081,
    WEBSOCKET_PORT = 8082, //process.argv[4] || 8082,
    RECORD_STREAM = false;
...
function startFFmpeg() {
    childProcess.exec(ffmpegCommand, (err, stdout, stderr) => {
        if (err) {
        ...
        console.log('ffmpeg is running', stdout.toString(), stderr.toString());
    });
}
